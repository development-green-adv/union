...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        </section><!-- / Kraj kontenta -->
    </div><!--// Kraj kontent wrapera -->
    ...
    <footer class="main-footer">
        ...
        <strong>&copy; <?php echo date('Y');?> <a target="_blank" href="https://www.green-adv.rs">Green Advertising</a>.</strong> Sva prava zadrzana
    </footer>
