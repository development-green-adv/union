                    ...
                    <div class="col-12 col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12 col-md-4">
                                ...
                                <label for="">Izaberite tip proizvoda</label>
                                <select class="form-control" name="lang">

                                    <option value="glavni">Glavni proizvod</option>
                                    <option value="pridruzeni">Pridruzeni proizvod</option>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12 col-md-4">
                                ...
                                <label for="">Dodatni naziv proizvoda</label>
                            ...
                            <div class="form-group col-12 col-md-4">
                                ...
                                <label>Izaberite brend</label>
                                <select class="form-control" name="brand">

                                    <option value="" selected disabled>Izaberite brand</option>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12 col-md-4">
                                ...
                                <input class="form-control" type="text" name="sifra">
                            ...
                            <div class="form-group col-12 col-md-4">
                                ...
                                <label>Nova cena proizvoda</label>
                                <input class="form-control" type="text" name="nova_cena">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12 col-md-4">
                                ...
                                <label>Visina popusta u procentima</label>
                                <input class="form-control" type="text" name="popust">

                            </div>

                            <div class="form-group col-12 col-md-4">

                                <label>Vreme trajanja popusta</label>
                                <input class="form-control" type="date" name="popust_vreme">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12 col-md-4">
                                ...
                                <input class="form-control" type="text" name="kolicina">

                            </div>

                            <div class="form-group col-12 col-md-4">

                                <input type="checkbox" name="na_naslovnoj" value="da"> Proizvod na naslovnoj
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12 col-md-12">
                                ...
                                <textarea class="form-control textarea" name="opis_product" placeholder="Unesite tekst ovde"></textarea>
