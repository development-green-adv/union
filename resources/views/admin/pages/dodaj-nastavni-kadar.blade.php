...
@section('data')
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-6">
            ...
            <form action="/admin/dodaj-nastavni-kadar" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    <div class="form-group col-12 col-md-12">
                        ...
                        <label>Opis</label>
                        <textarea class="form-control textarea" name="prof_text" rows="15" placeholder="Unesite tekst ovde"></textarea>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-12 col-md-6">
                        ...
                        <input class="form-control" type="text" name="pdf_link">
