...
@section('data')
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-6">
            ...
            <form action="/admin/dodaj-baner" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="forn-group col-12 col-md-6">

                        <label>Naziv linka</label>
                ...
                <div class="row">
                    <div class="form-group col-12 col-md-12">
                        <label>Slika banera -- Velicna <b style="color: red !important;">( 1920px x 550px )</b> i tezina slike manja od - <b style="color: red !important;">2mb</b></label><br>
