...
@section('data')
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-6">
            ...
            <form action="/admin/izmeni-nastavni-kadar" method="POST" enctype="multipart/form-data">
                @csrf

                <input type="hidden" name="id" value="{{ $nastavni->id }}">
                ...
                <div class="row">
                    <div class="form-group col-12 col-md-6">
                        ...
                        <select class="form-control" name="lang" id="langg">
                            ...
                            <option @if($nastavni->lang == "sr") selected @endif value="sr">Srpski</option>
                            <option @if($nastavni->lang == "en") selected @endif value="en">Engleski</option>
                        </select>
                    </div>

                    <div class="form-group col-12 col-md-6">
                        <label>Ime i prezime</label>
                        <input class="form-control" type="text" name="name" value="{{ $nastavni->name }}">
                    </div>
                ...
                <div class="row">
                    <div class="form-group col-12 col-md-12">
                        ...
                        <label>Opis</label>
                        <textarea class="form-control textarea" name="prof_text" rows="15" placeholder="Unesite tekst ovde">{{ $nastavni->prof_text }}</textarea>
                ...
                <div class="row">
                    <div class="form-group col-12 col-md-6">
                        ...
                        <input class="form-control" type="email" name="email" value="{{ $nastavni->email }}">
                    ...
                    <div class="form-group col-12 col-md-6">
                        ...
                        <input class="form-control" type="text" name="pdf_link" value="{{ $nastavni->pdf_link }}">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-12">
                        ...
                        <select class="form-control" name="status">
                            ...
                            <option @if($nastavni->status == 1) selected @endif value="1">Aktivan</option>
                            <option @if($nastavni->status == 0) selected @endif value="0">Neaktivan</option>
