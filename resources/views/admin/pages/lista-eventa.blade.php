                        ...
                        <tbody id="els">
                            ...
                            @if(count($rows))
                                ...
                                @foreach($rows as $data)
                                    ...
                                    <tr>
                                        <td style="width: 20%;">
                                            <a class="btn btn-primary" href="/admin/izmeni-event/{{ $data->id }}"><i class="far fa-edit"></i> Izmeni</a>
                                    ...
                                    <div class="modal fade" id="exampleModal{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="/admin/obrisi-event/{{ $data->id }}" class="btn btn-success">Da</a>
                                            </div>
                                            </div>
                                        </div>
                                    </div>
