                            ...
                            @if(count($rows))
                                ...
                                @foreach($rows as $data)
                                    ...
                                    <tr>
                                        ...
                                        <td><img style="height: 50px;" class="img-fluid" src="../public/images_gallery/{{ $data->baner_image }}"></td>
                                        <td>{{ $data->title }}</td>
                                        <td>{{ $data->subtitle }}</td>
                                        <td>{{ $data->link }}</td>
                                    ...
                                    <div class="modal fade" id="exampleModal{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="/admin/obrisi-baner/{{ $data->id }}" class="btn btn-success">Da</a>
                                            </div>
                                            </div>
                                        </div>
                                    </div>
