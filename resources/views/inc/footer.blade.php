        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-7 align-self-end">
                    <div>
                        <img class="img-fluid" src="{{ asset('images/web/footer-logo.png') }}" alt="Univerzitet Union">
                    </div>
                    ...
                    <p class="footer_union">
                        ...
                        sastavu u skladu sa zajedničkim evropskim tradicijama i vrednostima Republike Srbije. Kao 
                        zajednica visokoškolskih ustanova Univerzitet omogućava razmenu znanja i iskustava u različitim 
                    ...
                    <div class="row" style="margin-top: 30px;">
                        ...
                        <div class="col-12 col-md-4 mb-4 mb-md-0">
                            ...
                            <div class="footer_contact">
                                <p>rektor@unionnikolatesla.rs</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-5 footer_video align-self-end">
                    <h6>POGLEDAJTE NAŠ VIDEO</h6>
